...
import '../../../controller/searchForJobsController.dart';

class SearchForJobsPage extends StatelessWidget {

  SearchForJobsPage({super.key});
  final SearchForJobsControllerImpl searchForJobsControllerImpl = Get.put(SearchForJobsControllerImpl());
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text("Search for Jobs",style: TextStyle(
                      color: Colors.white,
                      fontSize: 25,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        searchForJobsControllerImpl.goToFilters();
                      },
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 20),
                child: Text("Available Job Types",style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                ),
                ),
                ...
                child: Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Obx(() {
                        bool isSelected = (searchForJobsControllerImpl.selectedIndex.value ?? -1) == index;
                        return GestureDetector(
                          onTap: () {
                            final field = searchForJobsControllerImpl.encodeFieldName(jobTypes[index]['title']);
                            searchForJobsControllerImpl.selectJobType(index, field);
                          },
                          child: Container(
                            decoration: BoxDecoration(
